...
export function ChatWidget() {
  ...
  return <>
    ...
    {!isOpen && <button onClick={() => setIsOpen(true)} className="fixed bottom-6 right-6 w-16 h-16 bg-[rgb(206,40,95)] rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-105 z-50" aria-label="Open chat">
      <img src="../../public/logo.png" alt="Asika Chat" className="w-10 h-10 rounded-full" />
    ...
    {isOpen && <div className={`fixed top-20 right-2 bg-white rounded-lg shadow-xl transition-all duration-300 z-50 border border-blue-100 ${isMinimized ? 'w-80 h-16' : 'w-[420px] h-[calc(100vh-120px)]'} max-w-[95vw] max-h-[100vh]`}>
      ...
      <div className="bg-[rgb(206,40,95)] text-white p-4 rounded-t-lg flex items-center justify-between">
        <div className="flex items-center gap-3">
          <img src="../../public/logo.png" alt="Asika" className="w-10 h-10 rounded-full border-2 border-white/30" />
          <div>
